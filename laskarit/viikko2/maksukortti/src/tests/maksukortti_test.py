...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_voi_ostaa_edullisen(self):
        ukortti=Maksukortti(2.5)
        ukortti.syo_edullisesti()
        self.assertEqual(str(ukortti),"Kortilla on rahaa 0.0 euroa")

    def test_voi_ostaa_maukkaan(self):
        ukortti=Maksukortti(4)
        ukortti.syo_maukkaasti()
        self.assertEqual(str(ukortti),"Kortilla on rahaa 0 euroa")
